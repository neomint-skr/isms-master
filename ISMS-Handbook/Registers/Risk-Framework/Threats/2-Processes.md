...
| G 0.11 | Failure or disruption of service providers | **Yes** | | SUP | V |
...
| G 0.33 | Staff absence | **Yes** | | HUMAN | V |
| G 0.34 | Terrorist attack | No | Physical security; measures at buildings/rooms level. | | |
| G 0.35 | Coercion, extortion or corruption | **Yes** | | HUMAN | C, I, V |
...
| G 0.42 | Social engineering | **Yes** | | HUMAN | C, I |
