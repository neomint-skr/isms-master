...
**Objective:** IS objectives without systematic tracking remain declarations of intent without measurable progress. Without a register, evidence of objective achievement is lacking — a central audit point in every certification audit.

The register records IS objectives with metrics, responsibilities, deadlines and achievement status. It provides the data basis for performance monitoring and the identification of improvement needs.
...
The organization's IS objectives are structured at three levels:
...
Objectives cascade: strategic objectives are translated into tactical objectives, which in turn determine operational targets. All objectives must be measurable (if practicable), consistent with the IS policy and backed by resources (Clause 6.2).
