...
**Objective:** ISO 27001 Clause 9.3 requires documented evidence of management reviews, and effective ISMS governance extends to risk reviews and steering committee sessions. Without a central log, evidence of governance meetings and their outcomes is scattered or absent.
...
| Date | Type | Participants | Key Decisions | Actions | Record Link |
|---|---|---|---|---|---|
| [YYYY-MM-DD] | [MR/Risk Review/Steering] | [participant list] | [key decisions] | [action references] | [Records/MR-YYYY-QN.md] |
